<form id="register_user" class="" tabindex="500" wire:submit.prevent='register'>
    ...
    <div class="job_title">
        ...
        <input type="text" wire:model.lazy='job_title' name="job_title" class="border-dark">
    ...
    <div class="sepcials">
        ...
        <select name="specials" class="form-control " wire:model.lazy='specials' class="border-dark" multiple style="height:80px">
