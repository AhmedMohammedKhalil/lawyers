        ...
        <div class="ads-tabs">
            <div class="tabs-menus">
                <ul class="nav panel-tabs">
                    <li class="me-3"><a href="#tab1" class="active" data-bs-toggle="tab">جميع الخدمات</a></li>
                    <li><a href="#tab2" data-bs-toggle="tab">إضافة خدمة جديد</a></li>
                </ul>
            </div>
                            ...
                            <tr id="tr_{{$s->id}}">
                                        ...
                                        <div class="media-body">
                                            <div class="card-item-desc ms-2 p-0 mt-0">
                                                <a href="javascript:void(0)" class="text-dark">
                                                    <h4 class="font-weight-bold">{{$s->title}}</h4>
                                                    <h5 class="font-weight-bold">{{$s->specialization->title}}</h5>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <a class="btn btn-outline-light btn-sm waves-effect waves-light"
                                        ...
                                        href="{{ route('lawyer.services.edit',['id'=>$s->id]) }}"><i
                                            class="fe fe-edit-2 fs-16"></i></a>
                                    <form action="{{  route('lawyer.services.delete',['id'=>$s->id])  }}" method="post" class="d-inline-block">
                                        @method('delete')
                                        @csrf
                ...
                <div class="tab-pane userprof-tab" id="tab2">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class=" m-b-20">
                                <div class="card-header">
                                    <h3 class="card-title">إضافة خدمة جديد</h3>
                                </div>
                                <div class="card-body">
                                    @livewire('lawyer.service.add')
                                </div>
                            </div>
                        </div>
