                ...
                <div class="col-lg-12 col-md-12">
                    <div class="wideget-user-desc text-center">
                        <div class="wideget-user-img">
                            ...
                            <img class="brround"
                                src="{{asset('assets/images/data/users/'.auth('user')->user()->id.'/'.auth('user')->user()->image)}}"
                                alt="img">
                            @else
                            @if(auth('user')->user()->gender == 'ذكر')
                        ...
                        <div class="user-wrap wideget-user-info">
                            <a href="javascript:void(0)">
                                <h4 class="font-weight-semibold text-white">{{auth('user')->user()->name}}</h4>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <ul class="side-menu">
                <li>
                    <a class="side-menu__item @if(Request::is('*profile*')) active @endif"
                        href="{{route('user.profile')}}"><i class="side-menu__icon fe fe-user"></i><span
                ...
                <li>
                    <a class="side-menu__item" href="{{route('user.logout')}}"><i
