        ...
        <nav class="horizontalMenu d-md-flex">
            <ul class="horizontalMenu-list">
                ...
                <li aria-haspopup="true" class="p-0 mt-1">
                    <span><a class="btn btn-primary" href="{{ route('user.login_register') }}">المستخدم <i class="fe fe-user me-1"></i></a></span>
                </li>
                <li aria-haspopup="true" class="p-0 mt-1 ms-3">
                    <span><a class="btn btn-primary" href="{{ route('lawyer.login_register') }}">المحامى<i class="fe fe-user me-1"></i></a></span>
                </li>
                <li aria-haspopup="true" class="p-0 mt-1 ms-3">
