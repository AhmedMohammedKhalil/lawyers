...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{asset('assets/images/brand/favicon/favicon.ico')}}" type="image/x-icon" />
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/images/brand/favicon/favicon.ico')}}" />
    ...
    <link id="theme" rel="stylesheet" type="text/css" media="all"
        href="{{asset('assets/color-skins-rtl/color.css')}}" />
    @livewireStyles()
    <style>
        .horizontalMenucontainer {
            background-image: url('{{asset("assets/images/banners/pattern3.png")}}');
        }
